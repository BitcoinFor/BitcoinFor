...
const string strMessageMagic = "BitcoinFor Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BitcoinFor", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1511282491, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "CryptoCurrency for everyone";
        CTransaction txNew;
        txNew.nTime = 1511282491;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1511282491;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1269610 : 1269610;
        ...
        assert(block.hashMerkleRoot == uint256("0xb38cfb6ecac0feb14b4a2c52046b650cf2a36a1067cf1af0fe890cb733dce9d1"));
...
unsigned char pchMessageStart[4] = { 0x2f, 0x2d, 0xc7, 0x95 };
